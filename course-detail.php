    ...
    <div class="course-hero-main">
      ...
      <div class="course-hero-meta" role="list">
        ...
        <span class="course-students" role="listitem" aria-label="764,815 students enrolled">
          <svg width="16" height="16" fill="none" stroke="#f7b500" stroke-width="2" aria-hidden="true">
            <circle cx="8" cy="8" r="7" />
          </svg>764,815 students
        </span>
      </div>
      ...
      <div class="course-meta-date" aria-label="Course last updated and language information">
        <svg width="14" height="14" fill="none" stroke="#999" stroke-width="2" aria-hidden="true">
        ...
        <span>
          ·
          <svg width="15" height="15" fill="none" stroke="#999" stroke-width="1.7" aria-hidden="true">
            <circle cx="7.5" cy="7.5" r="6.5" />
            <path d="M7.5 3v3.5l2.5 1.5M5 7.5h5" />
          </svg>
          English
        </span>
        <span>
          ·
          <svg width="15" height="15" fill="none" stroke="#999" stroke-width="1.7" aria-hidden="true">
            <rect width="11" height="7.5" x="2" y="4" rx="1.2" />
            <path d="M4.5 7.25A2 2 0 0 0 9 9.25" />
          </svg>
          English, Arabic [Auto]
        </span>
      </div>
          ...
          <div class="course-section">
            ...
            <div class="course-section-content open" id="section-1-content" role="region" aria-labelledby="section-1-toggle">
              <ul class="course-lecture-list">
                ...
                <li>
                  <svg width="18" height="18" fill="none" stroke="#1c1d1f" stroke-width="2" aria-hidden="true">
...
<div class="course-section-main">
  ...
  <section class="course-section-block" aria-labelledby="description-title">
    ...
    <a href="#" class="course-desc-more" aria-expanded="false" aria-controls="description-more" onclick="toggleDescription(this); return false;">
      Show more
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#5624d0" stroke-width="2" aria-hidden="true">
        <path d="M6 9l6 6 6-6" />
      </svg>
    </a>
      ...
      <div class="course-review-content">
        ...
        <div class="course-review-meta">
          ...
          <span class="course-review-rating" aria-label="4 stars rating">
            <svg viewBox="0 0 20 20" width="15" height="15" fill="#f69c08" aria-hidden="true">
              <path d="M10 15.27L16.18 19l-1.64-7.03L20 7.24l-7.19-.61L10 0 7.19 6.63 0 7.24l5.46 4.73L3.82 19z"></path>
            </svg>
            4 years ago
          </span>
        ...
        <div class="course-instructor-profile">
          ...
          <div class="course-instructor-meta">
            ...
            <div><svg width="16" height="16" fill="none" stroke="#6a6f73" stroke-width="1.5" aria-hidden="true">
                <circle cx="8" cy="8" r="7" />
              </svg> 1,263,843 Reviews</div>
            <div><svg width="16" height="16" fill="none" stroke="#6a6f73" stroke-width="1.5" aria-hidden="true">
                <circle cx="8" cy="8" r="7" />
                <path d="M4 14l8-8" />
              </svg> 4,237,490 Students</div>
            <div><svg width="16" height="16" fill="none" stroke="#6a6f73" stroke-width="1.5" aria-hidden="true">
                <circle cx="8" cy="8" r="7" />
                <path d="M8 4v8" />
              </svg> 87 Courses</div>

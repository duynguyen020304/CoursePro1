...
if (!isset($_SESSION['user']['userID']) || !isset($_SESSION['user']['token'])) {
                ...
                <div class="col-lg-4">
                    <div class="card shadow-sm mb-4">
                        <div class="card-body text-center">
                            <img
                                src="<?= $profileImagePath = APP_BASE_URL . CONTROLLER_FILE_PATH . '?action=load_img_profile&user_id=' . urlencode($_SESSION['user']['userID']) . '&image=' . urlencode($_SESSION['user']['profileImage'])?>"
                                alt="Avatar"

...
/**
 * Static class containing default permission seed data.
 * Natural key: name (e.g., 'admin.access', 'courses.view')
 */
class DefaultPermissions
{
    /**
     * @return array<int, array{name: string, display_name: string, description: string}>
     */

...
$h_known_app_subdir_markers = ['/admin/', '/api/', '/includes/',../../backend/Controller/Form/', '/view/', '/template/'];
            ...
            function renderSuggestions(courses) {
                ...
                courses.forEach(course => {
                    ...
                    if (course.images && course.images.length > 0 && course.images[0]) {
                        ...
                        img.src = `${appRootPat../../backend/Controller/Form/c_file_loader.php?act=serve_image&course_id=${course.courseID}&image=${encodeURIComponent(course.images[0]['imagePath'])}`;

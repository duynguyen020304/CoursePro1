...
const CONTROLLER_FILE_PATH =../../backend/Controller/Form/c_edit_profile.php';
                    ...
                    <section class="form-section">
                        ...
                        <form action="controller/c_edit_profile.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <?php
                                    $profileImagePath = 'assets/img/avatar-user.png';
                                    ...
                                    ?>
                                    <img src="<?php echo htmlspecialchars($profileImagePath) ?>" alt="Ảnh đại diện hiện tại" class="profile-image-current mb-2" id="currentProfileImage" onerror="this.onerror=null; this.src='assets/img/avatar-user.png';" />
                                </div>

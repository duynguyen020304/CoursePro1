...
$file_loader_base_url = APP_ROOT_PATH_RELATIVE_USER .../../backend/Controller/Form/c_file_loader.php';

if (!function_exists('callApi')) {
    function callApi(string $endpoint, string $method = 'GET', array $payload = []): array
    {
        $url = API_BASE_USER . '/' . ltrim($endpoint, '/');
...
if ($loggedInUserID && !$user_fetch_error) {
            ...
            if (isset($order['orderID'])) {
                ...
                if (isset($order_details_response['success']) && $order_details_response['success'] && !empty($order_details_response['data'])) {
                    ...
                    foreach ($details as $detail) {
                        if (isset($detail['courseID']) && !isset($purchased_courses_details[$detail['courseID']])) {
...
<head>
    ...
    <link href="<?php echo APP_ROOT_PATH_RELATIVE_USER; ?>/frontend/assets/css/bootstrap.min.css" rel="stylesheet" />
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css" rel="stylesheet" />
    <link href="<?php echo APP_ROOT_PATH_RELATIVE_USER; ?>/frontend/assets/css/user.css" rel="stylesheet" />
</head>

<body>

<?php include(__DIR__ . '/../templates/user_sidebar.php'); ?>
                        ...
                        <?php else: ?>
                            <?php foreach ($purchased_courses_details as $course): ?>
                                <div class="d-flex align-items-center mb-4 pb-2 border-bottom">
                                    <?php
                                    $course_image_url = APP_ROOT_PATH_RELATIVE_USER . "/public/images/course_placeholder.png";
                                    ...
                                    <a href="<?php echo APP_ROOT_PATH_RELATIVE_USER . '/watch_video.php?courseID=' . htmlspecialchars($course['courseID']); ?>" class="btn btn-sm btn-primary ms-3">Bắt đầu học</a>
                                </div>
                            <?php endforeach; ?>
                            <?php if (count($purchased_courses_details) > 3) :
                                ?>
                ...
                <?php if ($user_profile_data): ?>
                    <div class="card shadow-sm mb-4">
                        <div class="card-body text-center">
                            <?php
                            $profileImagePath = APP_ROOT_PATH_RELATIVE_USER . "/public/images/default_avatar.png";
                            ...
                            ?>
                            <img src="<?= $profileImagePath ?>" alt="Avatar" class="profile-avatar mb-2" onerror="this.onerror=null;this.src='assets/img/avatar-user.png'" />
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <img src="../assets/img/reactjs_course.png" alt="Suggested Course" class="course-thumbnail" onerror="this.onerror=null;this.src='https://placehold.co/80x50/dee2e6/6c757d.png?text=Suggest+1';" />
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex align-items-center">
                            <img src="<?php echo APP_ROOT_PATH_RELATIVE_USER; ?>/frontend/assets/img/photograph_course.webp" alt="Suggested Course" class="course-thumbnail" onerror="this.onerror=null;this.src='https://placehold.co/80x50/dee2e6/6c757d.png?text=Suggest+2';" />
                            <div class="flex-grow-1">
...
<script src="<?php echo APP_ROOT_PATH_RELATIVE_USER; ?>/frontend/assets/js/bootstrap.bundle.min.js"></script>
<script>

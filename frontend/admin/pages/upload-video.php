...
$controller_path_relative = $app_root_path_relative .../../backend/Controller/Form/c_video.php';
$c_video_controller_url = $protocol . '://' . $host . $controller_path_relative;

$c_file_loader_controller_path_relative = $app_root_path_relative .../../backend/Controller/Form/c_file_loader.php';
...
<div class="dashboard-container">
    <?php if (file_exists(__DIR__ . '/../templates/dashboard.php')) include __DIR__ . '/../templates/dashboard.php'; ?>

...
<div class="modal fade" id="userModal" tabindex="-1" aria-labelledby="userModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="userForm" action="../../backend/Controller/Form/c_user_management.php" method="POST" enctype="multipart/form-data">
...
<form id="deleteUserForm" action="../../backend/Controller/Form/c_user_management.php" method="POST" style="display: none;">
...
<script>
    ...
    function getUserProfileImageURL(profileImagePath, userID) {
        ...
        if (USER_IMAGE_HANDLER_SCRIPT && !profileImagePath.startsWith('http')) {
            ...
            if (effectiveUserID) {
                console.log(`${PROJECT_BASE_UR../../backend/Controller/Form/${USER_IMAGE_HANDLER_SCRIPT}?act=serve_user_image&user_id=${encodeURIComponent(effectiveUserID)}&image=${encodeURIComponent(imageName)}`)
                return `${PROJECT_BASE_UR../../backend/Controller/Form/${USER_IMAGE_HANDLER_SCRIPT}?act=serve_user_image&user_id=${encodeURIComponent(effectiveUserID)}&image=${encodeURIComponent(imageName)}`;
            }
